...
namespace BoostCsharp {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class PersonneDataTable : global::System.Data.TypedTableBase<PersonneRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersonneRow AddPersonneRow(string Nom, string Prenom, int Age, string Email) {
...
namespace BoostCsharp.Database1DataSetTableAdapters {
    ...
    public partial class PersonneTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Personne] ([Nom], [Prenom], [Age], [Email]) VALUES (@Nom, @Pre" +
                "nom, @Age, @Email);\r\nSELECT Id, Nom, Prenom, Age, Email FROM Personne WHERE (Id " +
                "= SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Personne] SET [Nom] = @Nom, [Prenom] = @Prenom, [Age] = @Age, [Email] = @Email WHERE (([Id] = @Original_Id) AND ((@IsNull_Nom = 1 AND [Nom] IS NULL) OR ([Nom] = @Original_Nom)) AND ((@IsNull_Prenom = 1 AND [Prenom] IS NULL) OR ([Prenom] = @Original_Prenom)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT Id, Nom, Prenom, Age, Email FROM Personne WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BoostCsharp.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nom, Prenom, Age, Email FROM dbo.Personne";
        ...
        public virtual int Fill(Database1DataSet.PersonneDataTable dataTable) {
        ...
        public virtual Database1DataSet.PersonneDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.PersonneDataTable dataTable = new Database1DataSet.PersonneDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.PersonneDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nom, string Original_Prenom, global::System.Nullable<int> Original_Age, string Original_Email) {
        ...
        public virtual int Insert(string Nom, string Prenom, global::System.Nullable<int> Age, string Email) {
            if ((Nom == null)) {
        ...
        public virtual int Update(string Nom, string Prenom, global::System.Nullable<int> Age, string Email, int Original_Id, string Original_Nom, string Original_Prenom, global::System.Nullable<int> Original_Age, string Original_Email, int Id) {
            if ((Nom == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nom, string Prenom, global::System.Nullable<int> Age, string Email, int Original_Id, string Original_Nom, string Original_Prenom, global::System.Nullable<int> Original_Age, string Original_Email) {
            return this.Update(Nom, Prenom, Age, Email, Original_Id, Original_Nom, Original_Prenom, Original_Age, Original_Email, Original_Id);
        }
    }
